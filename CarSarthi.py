...
# --- Title ---
st.markdown("<h1 style='text-align: center;'>🚘CarSarthi</h1>", unsafe_allow_html=True)
st.markdown("<h2 style='text-align: center;'>Car Resale Value Estimator with Smart Recommendations</h2>", unsafe_allow_html=True)
